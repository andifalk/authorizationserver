...
public class IntrospectionEndpoint {
  ...
  public IntrospectionEndpoint(TokenService tokenService, UserService userService, JsonWebTokenService jsonWebTokenService) {
  ...
  @PostMapping
  public IntrospectionResponse getToken(@RequestHeader("Authorization") String authorizationHeader,
